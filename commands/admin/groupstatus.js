...
// 🔤 Default font style for text statuses
// Change the number below to switch font (0–8 depending on WhatsApp version)
const DEFAULT_FONT_STYLE = 6;
...
async function groupStatus(sock, jid, content) {
  ...
  const inside = await generateWAMessageContent(content, {
    ...
    font: DEFAULT_FONT_STYLE, // 🔤 Change font style here
  });
